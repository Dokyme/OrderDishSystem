...
public class InterceptorForAll implements HandlerInterceptor {
    ...
    public boolean manager(String URI)
    {
        String[] forTrue={"/identity","/checkout/{orderId}","/checkout","/checkout/{orderId}","/statistics","/order/statistics","/dish/{dishId}"
                ,"/dish","/user","/user/{userId}"};
        for(int i=0;i<10;i++)
        {
            if(URI==forTrue[i])
            {
    ...
    public boolean waiter(String URI)
    {
        String[] forTrue={"/identity","order Application/json","/order/{orderId}","/dish","/table","/table/{tableId}","/evaluation/{orderId}"};
        for(int i=0;i<10;i++)
        {
            if(URI==forTrue[i])
            {
    ...
    public boolean cook(String URI)
    {
        String[] forTrue={"/cooking/{orderInfold}","/cooking","serving/{orderInfold}"};
        for(int i=0;i<10;i++)
        {
            if(URI==forTrue[i])
            {
